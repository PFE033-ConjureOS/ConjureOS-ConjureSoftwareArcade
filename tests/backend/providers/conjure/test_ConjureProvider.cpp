...
void test_ConjureProvider::simple()
{
...
void test_ConjureProvider::with_meta()
{
...
void test_ConjureProvider::custom_assets()
{
...
void test_ConjureProvider::custom_assets_multi()
{
...
void test_ConjureProvider::custom_directories()
{
...
void test_ConjureProvider::multifile()
{
...
void test_ConjureProvider::multicoll()
{
...
void test_ConjureProvider::nonASCII()
{
    struct TestEntry {
        QString title;
        QString filename;
...
void test_ConjureProvider::relative_files_only()
{
...
void test_ConjureProvider::relative_files_with_dirs()
{
...
void test_ConjureProvider::autoparenting()
{
...
void test_ConjureProvider::entryless_games()
{
