...
namespace model {
    ...
    QHash<int, QByteArray> GameListModel::roleNames() const {
        static QHash<int, QByteArray> ROLE_NAMES{
                ...
                {Roles::Leaderboard,    QByteArrayLiteral("leaderboardModel")},
        };
        return ROLE_NAMES;
    }
    ...
    QVariant GameListModel::data(const QModelIndex &index, int role) const {
        ...
        switch (role) {
            ...
            case Roles::HasLeaderboard:
                return QVariant::fromValue(game.hasLeaderboard());
            case Roles::Leaderboard:
                return QVariant::fromValue(game.leaderboardModel());
            default:
                return {};
        }
    }
