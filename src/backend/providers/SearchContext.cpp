...
SearchContext::SearchContext(QStringList game_dirs, QObject *parent)
    : QObject(parent), m_root_game_dirs(std::move(game_dirs)), m_pending_downloads(0) {}
...
std::pair<std::vector<model::Collection *>, std::vector<model::Game *>>
SearchContext::finalize(QObject *const parent) {
    // TODO: C++17
